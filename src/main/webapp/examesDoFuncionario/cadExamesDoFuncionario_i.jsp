				...
				<div class="card mt-5">
					<div class="card-header">
						<div class="row">
							<div class="col-sm-5">
								...
								<a href="${todos}" class="btn btn-success" >Exames Do Funcionario</a>
							</div>
					...
					<div class="card-body">
						...
						<div class="row align-items-center mt-3">
							...
							<div class="col-sm-5">
								<s:textfield cssClass="form-control" id="exame" name="exameFuncionarioVo.codExame"/>							
							</div>	
						</div>
						...
						<div class="row align-items-center mt-3">
							...
							<div class="col-sm-5">
								<s:textfield cssClass="form-control" id="funcionario" name="exameFuncionarioVo.codFunc"/>							
							</div>	
						</div>
					</div>
