					...
					<tbody>
						<s:iterator value="funcionarios" >
							<tr>
								...
								<td>${nome}</td>
							<td class="text-end">
								<s:url action="todosExamesFuncionario" var="examesFuncionario" /> 
								<a href="${examesFuncionario}" class="btn btn-dark"> 
									<s:text name="label.exames.funcionario" />
								</a>
								
								<s:url action="atualizarFuncionarios" var="atualizar">
					...
					<tfoot class="table-secondary">
						<tr>
							<td colspan="3">
								...
								<s:url action="todosExames.action" var="exame" /> 
